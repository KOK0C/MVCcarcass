...
return [
    ...
    '^forum/ajax/deleteComment$'     => ['controller' => 'Forum', 'action' => 'ajaxDeleteComment'],
    '^forum/ajax/updateComment$'     => ['controller' => 'Forum', 'action' => 'ajaxUpdateComment'],
    '^forum/ajax/showUpdateComment$' => ['controller' => 'Forum', 'action' => 'ajaxShowUpdateComment'],
